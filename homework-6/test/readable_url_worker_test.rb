require 'rspec/core'
require_relative '../web-client/App/Core/readable_url_worker'

RSpec.describe ReadableURLWorker do
  it "check that url identical" do
    url_woker = ReadableURLWorker.new("/some_url", "GET")
  ...
  it "check that url with another requested method non identical" do
    url_woker = ReadableURLWorker.new("/some_url/16", "POST")
  ...
  it "should return arguments as hash after last correct url" do
    url_worker = ReadableURLWorker.new("/index/15/16", "GET")
